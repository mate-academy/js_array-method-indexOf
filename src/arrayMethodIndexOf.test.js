...
test(`without valueToFind`, () => {
  expect(source.indexOf2()).toBe(-1);
});

test(`indexOf2('11') = 0`, () => {
  expect(source.indexOf2('11')).toBe(0);
});

test(`indexOf2(11) = -1`, () => {
  expect(source.indexOf2(11)).toBe(-1);
});

test(`indexOf2('1') = -1`, () => {
  expect(source.indexOf2('1')).toBe(-1);
});

test(`indexOf2('11', 1) = -1 fromIndex 1`, () => {
  expect(source.indexOf2('11', 1)).toBe(-1);
});

test(`indexOf2('') = 3`, () => {
  expect(source.indexOf2('')).toBe(3);
});
